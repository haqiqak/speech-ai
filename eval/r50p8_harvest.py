"""
eval/r50p8_harvest.py -- R50 Phase 8, step 1: run the NEW 54-sentence
corpus (eval/r50p8_corpus.py) through TODAY's live production engine
...
from r50p8_corpus import SENTENCES, PROFILES  # noqa: E402

ROOT = Path(__file__).resolve().parent.parent
OUT_PATH = ROOT / "eval" / "r50_dataset" / "phase8_raw_harvest.json"


def _build_profile(tag: str, spec: dict) -> DifficultyProfile:
    p = DifficultyProfile(profile_name=f"__r50p8_{tag}__")
