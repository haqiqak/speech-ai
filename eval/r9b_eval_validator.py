...
MODEL_PATH = EVAL / "r9b_validator_model" / "final"
...
with open(EVAL / "r50_dataset" / "r9b_eval_results.json", "w", encoding="utf-8") as f:
    json.dump({
...
print("\nwrote eval/r50_dataset/r9b_eval_results.json")
