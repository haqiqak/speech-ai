...
**[NOT DONE]** No verdict — human or Claude — recorded yet on these 6. Same rule as before: only once the participant's picks arrive, in the same session, via `ingest_real_human_pair.py`.
